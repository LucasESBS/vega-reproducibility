...
def train_vega():
    ...
    # Initialize CV
    kfold = KFoldTorch(cv=10, n_epochs=N_EPOCHS, lr=LR, train_p=25, test_p=25, num_workers=0, save_all=True, save_best=False, path_dir=dir_name, model_prefix='vega_')
    ...
    np.save(dir_name+'10CV_vega.npy', kfold.cv_res_dict)
    return
