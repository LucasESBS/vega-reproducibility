...
def train_vega():
    ...
    random_seed = 1
    # Out dir
    local_out = '/trained_models/organoid/'
    ...
    # Initialize CV
    kfold = KFoldTorch(cv=10, n_epochs=N_EPOCHS, lr=LR, train_p=10, test_p=10, num_workers=0, save_all=True, save_best=False, path_dir=dir_name, model_prefix='vega_organoid_')
    ...
    np.save(dir_name+'10CV_vega_organoid.npy', kfold.cv_res_dict)
    return
