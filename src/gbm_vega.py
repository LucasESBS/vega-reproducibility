...
def train_vega():
    ...
    pathway_file = "./data/gbm_aracne.gmt"
    LR = 1e-4
    N_EPOCHS=500
    p_drop = 0.5
    beta = 0.00005
    ...
    model.train_vega(n_epochs=N_EPOCHS, lr=LR, train_size=0.8, batch_size=batch_size, use_gpu=True)
    model.save('.'+local_out+'gbm_vega/', save_adata=True, save_history=True)
    # Done
